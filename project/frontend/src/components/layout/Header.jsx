      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-[#1a1a2e] py-4 border-t border-[#2c2c3e] shadow-md text-white">
          ...
          <nav className="flex flex-col items-center gap-3 px-4">
            {isAuthenticated ? (
              <>
                <a href="/profile" className="block text-gray-200 hover:text-cyan-400 w-full py-2 text-center">Profile</a>
                <a href="/settings" className="block text-gray-200 hover:text-cyan-400 w-full py-2 text-center">Settings</a>
                <button onClick={onSignOutClick} className="block text-gray-200 hover:text-cyan-400 w-full py-2 text-center">Sign Out</button>
              </>
            ) : (
              <>
                <button
